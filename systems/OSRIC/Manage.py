    ...
    class AdventureServer(Manage):
        def __init__(self, fields):
            ...
            def save_adventure_data(flds):
                return {
                    'Default Filename': f'''{flds['Title']}.json''',
                    'File Type': adventure_file_type,
                    'Caption': 'Save Adventure',
                }
            ...
            self.add_row([empty, resource_fonts])
            self.add_row([empty, adventure_font])
            self.add_row([hr, ])
